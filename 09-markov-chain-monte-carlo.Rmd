...
map_dfr(
  ...
  geom_vline(
    data = . %>% 
      ...
      slice_max(n_eff) %>% 
      ungroup(), 
    aes(xintercept = n_warmup, colour = param), 
    linetype = 2
  ) + 
  scale_colour_brewer(type = "qual") + 
  scale_y_continuous(labels = scales::label_comma()) + 
  labs(
    subtitle = "Effective number of samples for 2,000 iterations", 
...
It seems clear that less is more for this simple model: $N_{\text{eff}}$ drops off dramatically for all parameters at or before 750 warmup runs. 
