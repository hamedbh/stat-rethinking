...
The relationship is no longer just linear. There are better ways to capture this than by adding higher powers of the predictor, but this will show weaknesses. The model would be:
